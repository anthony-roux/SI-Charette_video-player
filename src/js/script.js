...
function generateSliderElement(picture, title) {
  return "<div class='slide slideCard'>" +
  "<img class='over img' src='"+picture+"' alt='' />" +
  "<div class='slideCard__info'>" +
    "<img class='slideCard__add' src='"+iconAdd+"' alt='add' />" +
    "<img class='slideCard__star' src='"+iconStar+"' alt='star' />" +
    "<div class='slideCard__lecture'>" +
      "<img class='slideCard__button' src='"+iconPlay+"' alt='' />" +
