...
class Episode {
  ...
  newElement() {
    ...
    episodeCard.style.backgroundImage =
      "linear-gradient(90deg, rgba(0, 0, 0, 0.6) 0%, rgba(0, 0, 0, 0.6) 96.25%), url('" +
      this.urlImg +
      "')";
...
const EpisodeS01E01 = new Episode(
  '01',
  '2000 ans plus tard',
...
const EpisodeS01E02 = new Episode(
  '02',
  'Ce jour là',
  "Alors que l'unité de Levi parvient à reprendre une ville aux Titans, elle est appelée à l'aide pour éliminer les créatures qui ont envahi la cité...",
  '24',
  videoS01E02,
  urlImgS01E02
);
const EpisodeS01E03 = new Episode(
  '03',
  "Réveil de l'humanité 1/2",
...
const EpisodeS01E04 = new Episode(
  '04',
  "Réveil de l'humanité 2/2",
...
const EpisodeS01E05 = new Episode(
  '05',
  'Première bataille',
...
const EpisodeS01E06 = new Episode(
  '06',
  'Une petite lame',
  "Armin se réveille, entouré par Connie, Ymir et l'équipe de Krista. Il fond en larmes lorsqu'on lui demande ce qu'il est advenu de son équipe.",
  '24',
  videoS01E02,
  urlImgS01E06
);
const EpisodeS01E07 = new Episode(
  '07',
  'Courte lame',
  'Les survivants, incapables de gravir le mur, perdent le moral quand des titans détruisent les dépôts les plus proches, où ils espéraient trouver du carburant.',
  '24',
  videoS01E01,
  urlImgS01E07
);
const EpisodeS01E08 = new Episode(
  '08',
  'District de Trost 1/2',
  "Alors que le dépôt est entouré par les Titans, Armin a l'idée d'utiliser le Rogue Titan pour les détruire. Pendant ce temps, Jean et les autres atteignent le dépôt, au prix de lourdes pertes...",
  '24',
  videoS01E02,
  urlImgS01E08
);
const EpisodeS01E09 = new Episode(
  '09',
  'District de Trost 2//2',
  "Alors que l'unité de Levi parvient à reprendre une ville aux Titans, elle est appelée à l'aide pour éliminer les créatures qui ont envahi la cité...",
  '24',
  videoS01E01,
  urlImgS01E09
);
const EpisodeS01E10 = new Episode(
  '10',
  'Répondre',
  "Eren récupère de sa transformation, qui lui a permis de sauver Armine et Mikasa. Il pense détenir la clé de la préservation de l'humanité et le moyen de détruire les Titans...",
  '24',
  videoS01E02,
  urlImgS01E10
);
