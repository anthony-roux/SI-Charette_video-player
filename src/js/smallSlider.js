...
let list = document.querySelector('.my-slider--3');
...
let fantastic = document.querySelector('.my-slider--4');
...
let police = document.querySelector('.my-slider--5');
...
let comedy = document.querySelector('.my-slider--6');
